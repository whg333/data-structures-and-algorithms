...
public class JavaMapTest {
    ...
    @Before
    public void before() {
        System.out.println("JavaMapTest before");
    }

    @Test
    public void test() {
        testMap(new java.util.LinkedHashMap<>());
    }

    private void testMap(java.util.Map<Integer, Integer> map) {
    ...
    @After
    public void after() {
        System.out.println("JavaMapTest after");
    }
