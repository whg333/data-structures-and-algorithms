...
@RunWith(Suite.class)
@SuiteClasses({BinarySearchTest.class, QuickSortTest.class, SortUtilTest.class, JavaListTest.class, ListTest.class,
    StackTest.class, QueueTest.class, MapTest.class, SetTest.class, BinarySearchTreeTest.class})
